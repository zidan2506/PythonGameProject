...
def animation(poke_xy,flight_xy,ball_xy):
    ...
    while not poke_fixed:
        ...
        if poke_col >= poke_xy[1]+10:
            ...
            poke_fixed = True
        # draw_art(poke_xy[0],poke_col,poke)
        # sys.stdout.flush()
        # time.sleep(0.09)
    ...
    while not ball_fixed:
        ...
        if ball_col <= poke_xy[1]+45:
            ...
            ball_fixed = True
        # draw_art(flight_row,flight_xy[1],flight)
        # sys.stdout.flush()
        # time.sleep(0.01)
    while not flight_fixed:
        ...
        if flight_row >= flight_xy[0]:
            ...
            flight_fixed = True
            # draw_art(flight_xy[0], flight_xy[1],color_split(flight,2))

        # draw_art(ball_xy[0],ball_col,ball)
        # sys.stdout.flush()
        # time.sleep(0.05)
# sys.stdout.write(f'{esc}[?25l')
lm = 0
